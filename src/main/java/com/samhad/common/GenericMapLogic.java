...
public class GenericMapLogic {
    ...
    public void exportMap(Text value, Mapper.Context context, boolean CYCLogic) throws IOException, InterruptedException {
    ...
    public void importMap(Text value, Mapper.Context context, boolean CYCLogic) throws IOException, InterruptedException {
